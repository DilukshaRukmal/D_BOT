...
#creating the model
net = tflearn.input_data(shape=[None, len(training[0])]) #input
net = tflearn.fully_connected(net,32) #FC
net = tflearn.fully_connected(net,16) #FC
...
def chat():
    ...
    while True:
        ...
        if results_index > 0.7:
            ...
            print("D_BOT: ",random.choice(responses))     
        else:
            print("D_BOT: I don't know , try again with another question")
